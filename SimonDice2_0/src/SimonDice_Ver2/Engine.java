      ...
      public int play(tModo _modo){
        ...
        coloresSecuencia = 3;
    	  ...
    	  _opcion = scanner.nextInt();
                    ...
                    case 1:
    	            jugador.setPuntuacion(play(tModo.ModoFacil));
    	            System.out.println("Su puntuacion final es: " + jugador.getPuntuacion());
    	            break;
    	  
                   case 2:
                	   jugador.setPuntuacion(play(tModo.ModoDificil));
       	            System.out.println("Su puntuacion final es: " + jugador.getPuntuacion()*2);
    	           break;
